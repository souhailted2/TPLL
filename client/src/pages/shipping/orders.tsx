...
export default function ShippingOrders() {
  ...
  const filteredOrders = useMemo(() => {
    ...
    switch (activeFilter) {
      ...
      default:
        return orders.filter((o: any) => ['completed', 'shipped', 'received'].includes(o.status));
    }
  }, [orders, activeFilter]);
                          ...
                          <TableCell>
                            <div className="flex justify-end">
                              ...
                              {order.status === 'shipped' && (
                                <span className="text-sm text-slate-400">في الطريق</span>
                              )}
                              {order.status === 'received' && (
                                <span className="text-sm text-green-600">تم التسليم</span>
                              )}
                            </div>
                          </TableCell>
                        </TableRow>
